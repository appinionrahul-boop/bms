...
<div class="footer row">
    ...
    <div class="col">
        <a  href="https://softustechbd.com" ><img src="/Logo-Main.png" alt="Panchagar Zilla Parishad" class="float-right" style="width:125px;height:30px;margin-left:30pxs"> </a>    <p  class="float-right" style="margin-top: 5px" > Developed By © </p> 
    </div>
  
  
    {{-- <img src="/Logo-Main.png"" alt="Panchagar Zilla Parishad" class="brand-image " style=""> --}}
</div>
