            ...
            @foreach ($expenseSubCategory as $item)
                <tr>
                    ...
                    <td class="align-middle edtBTN">
                        ...
                        <a class="mb-2 mr-2 btn-icon btn-icon-only btn btn-success" href="" data-toggle="tooltip" data-placement="top" title="Edit " ><i class="icofont icofont-edit"  style="color: white"></i></a>
                        <a class="mb-2 mr-2 btn-icon btn-icon-only btn btn-danger" href="" data-toggle="tooltip" data-placement="top" title="Delete" ><i class="icofont icofont-trash"  style="color: white"></i></a>
                    </td>
                </tr>
                <p hidden> {{ $sl++ }}</p>
