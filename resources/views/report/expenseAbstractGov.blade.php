...
<div class="card shadow-sm report-card">
  <div class="card-header">
    <h5 class="mb-0">ব্যায়ের এবস্ট্রাক্ট রিপোর্ট</h5>
  </div>

  <div class="card-body">
    <form action="{{ url('/expense-abstract-reportGov') }}" method="POST">
      @csrf
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // init end first so we can set minDate from start change
